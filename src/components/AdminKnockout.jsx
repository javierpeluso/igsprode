...
function buildLaterRoundMatches(knockoutResults) {
  ...
  const qf = [
    ...
    { id: 'QF_M98',  home: getWinner('R16_M91'), away: getWinner('R16_M92'), date: '11 jul', label: 'Cuartos M98',  kickoff: '2026-07-11T17:00:00-03:00' },
    { id: 'QF_M99',  home: getWinner('R16_M93'), away: getWinner('R16_M94'), date: '10 jul', label: 'Cuartos M99',  kickoff: '2026-07-10T16:00:00-03:00' },
  ...
  const sf = [
    { id: 'SF_M101', home: getWinner('QF_M97'),  away: getWinner('QF_M99'),  date: '14 jul', label: 'Semi M101', kickoff: '2026-07-14T16:00:00-03:00' },
    { id: 'SF_M102', home: getWinner('QF_M98'),  away: getWinner('QF_M100'), date: '15 jul', label: 'Semi M102', kickoff: '2026-07-15T16:00:00-03:00' },
  ];
  const tp = [
